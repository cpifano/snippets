...
window.webcam = {
	...
	swf_url: 'swf/webcam.swf', // URI to webcam.swf movie (defaults to cwd)
	shutter_url: 'audio/shutter.mp3', // URI to shutter.mp3 sound
	api_url: 'php/test.php', // URL to upload script
